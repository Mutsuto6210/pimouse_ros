...
from pimose_ros.msg import MusicAction, MusicResult, MusicFeedback, MusicGoal
...
class BuzzerTest(unittest.TestCase):
    ...
    def test_put_value(self):
        ...
        with open("/dev/rtbuzzer0","r") as f:
            data = f.readline()
            self.asserEqual(data,"1234\n","value does notwritten to rtbuzzer0")
    ...
    def test_music(self):
        ...
        self.asserFalse(goal.freqs == self.device_values,"not stopped")
